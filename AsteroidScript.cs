...
public class AsteroidScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Asteroid.angularVelocity = Random.insideUnitSphere * rotationSpeed; // angularVelocity - угловая скорость, как пример = new Vector3(50, 0, 0);
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        Destroy(other.gameObject); // уничтожаем объект, с которым столкнулся астероид
                                   // destroy the object that asteroid collided with
