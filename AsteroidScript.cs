...
public class AsteroidScript : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        Instantiate(asteroidExplosion, transform.position, Quaternion.identity); // первый аргумент - "что" - создать (взрыв), второй аргумент - "где" создать взрыв, третье - вращение (нулевое);
